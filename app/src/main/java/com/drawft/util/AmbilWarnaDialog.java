...
public class AmbilWarnaDialog {
	...
	final TextView viewCursor;
	final TextView viewTarget;
	 ...
	 */
	public AmbilWarnaDialog(final Context context, int oldcolor, int color, OnAmbilWarnaListener listener) {
		this.listener = listener;
		Color.colorToHSV(color, currentColorHsv);
		final View view = LayoutInflater.from(context).inflate(R.layout.color_picker, null);
		viewHue = view.findViewById(R.id.ambilwarna_viewHue);
		viewSatVal = (AmbilWarnaKotak) view.findViewById(R.id.ambilwarna_viewSatBri);
		viewCursor = (TextView) view.findViewById(R.id.ambilwarna_cursor);
		viewCursor.setTypeface(GroupDrawft.fontFeather);
		viewTarget = (TextView) view.findViewById(R.id.ambilwarna_target);
		viewTarget.setTypeface(GroupDrawft.fontFeather);
		...
		viewHue.setOnTouchListener(new View.OnTouchListener() {
			@Override public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_MOVE
					...
					viewSatVal.setHue(getHue());
					moveCursor();
					ok.setBackgroundColor(getColor());
